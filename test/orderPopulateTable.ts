...
describe("Order populate table", () => {
  ...
  it('order create function - should be "Failed to create order"', async () => {
    const data: APIGatewayProxyEvent = {
      body: '{"data": {"object": {"payment_status": "not_paid", "customer_details": {"email": "test@test.com"}, "client_reference_id": "username-string"}}}',
    };
  ...
  it('order create function - should be "Failed to get cart"', async () => {
    const data: APIGatewayProxyEvent = {
      body: '{"data": {"object": {"payment_status": "paid", "customer_details": {"email": "test@test.com"}, "client_reference": "username-string"}}}',
    };
  ...
  it('order create function - should be "Cart not found"', async () => {
    const data: APIGatewayProxyEvent = {
      body: '{"data": {"object": {"payment_status": "paid", "customer_details": {"email": "test@test.com"}, "client_reference_id": "username-string_error"}}}',
    };
  ...
  it('order create function - should be "Error email value not found"', async () => {
    const data: APIGatewayProxyEvent = {
      body: '{"data": {"object": {"payment_status": "paid", "customer_details": {"email_error": "test@test.com"}, "client_reference_id": "username-string"}}}',
    };
